...
if hf_binaries == True:
    ...
    download_file('https://huggingface.co/VatsaDev/NanoCode/resolve/main/valTotal.bin','valtotal.bin')
    download_file('https://huggingface.co/VatsaDev/NanoCode/resolve/main/trainTotal.bin', 'traintotal.bin')
